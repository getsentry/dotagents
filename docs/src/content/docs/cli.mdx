...
generates target adapters from the portable core. Legacy generalized manifests
remain supported during migration. Client-specific extension namespaces are
preserved but are never translated into other clients' formats.
