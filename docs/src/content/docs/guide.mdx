...
manifests during migration. Dotagents preserves each authored manifest for its
matching client and projects only the portable skills and MCP into unrelated
targets.
