...
plugins, and broken symlinks. Use `dotagents sync` to repair generated runtime
config drift. Doctor is especially useful when migrating from an older version.
