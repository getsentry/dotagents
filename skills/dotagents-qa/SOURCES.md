...
| `skills/dotagents-qa/Dockerfile` | non-root QA image and installed Claude, Copilot, Codex, OpenCode, and Pi CLIs |
...
- Use native no-auth Claude/Copilot/Codex management commands, OpenCode skill and MCP resource discovery, and Pi link inspection without claiming model invocation.
